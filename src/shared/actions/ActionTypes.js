...
export const ADD_MAP_MARKER_SUCCESS = "ADD_MAP_MARKER_SUCCESS";
export const ADD_MAP_MARKER_FAILURE = "ADD_MAP_MARKER_FAILURE";
export const REMOVE_MAP_MARKER = "REMOVE_MAP_MARKER";
export const REMOVE_MAP_MARKER_SUCCESS = "REMOVE_MAP_MARKER_SUCCESS";
export const REMOVE_MAP_MARKER_FAILURE = "REMOVE_MAP_MARKER_FAILURE";